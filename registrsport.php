...
include "config.php";
include "\models\modelRegistrationGym.php";
include "\models\modelLoginGym.php";
...
if(isset($_POST['submit']))
{
    ...
    if(strlen($pass) < 6)
    {
        $err[] = "Довжина паролю не менше 6 символів.";
    }
...
<section class="formreg">
        ...
        <form action=""  method="post">
            ...
            <input class="input-form" type="text" id="name" name="name" placeholder="SportLife" required="">
            <label for="e-mail">E-Mail</label>
            <input class="input-form" type="text" id="e-mail" name="email" placeholder="example@gmail.com" required="">
            <label for="phone">Пароль </label>
            <input class="input-form" type="password" id="password" name="password" placeholder="password">
            <label for="phone">Телефон </label>
            <input class="input-form" type="number" id="telephone" name="tele" placeholder="+380673784511">
